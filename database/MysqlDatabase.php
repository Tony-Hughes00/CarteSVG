...
Class MysqlDatabase  {
    ...
    public function __construct(?string $db_name, ?string $db_user = 'root', ?string $db_password = '', ?string $db_host = 'localhost') {
	...
	public function getPDO() :PDO {
		if ($this->pdo === null) {
			echo 'mysql:dbname=' . $this->db_name . ';host=' . $this->db_host . ', ' . $this->db_user . ', ' . $this->db_password . '';
